...
export const metadata = {
  title: 'Market Signal — Competitive Intelligence Dashboard',
  description:
    'Real-time competitive intelligence: source-graded market news, sentiment-tagged stories, watchlist tracking, and daily digests.',
};
